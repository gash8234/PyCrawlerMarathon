...
class PttcrawlerSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ptt.cc/bbs/Stock/M.1623752325.A.756.html',
                  'https://www.ptt.cc/bbs/sex/M.1623732808.A.F6F.html'
                 ]
    cookies = {'over18': '1'}
    ...
    def parse(self, response):
        ...
        metas = main_content.select('div.article-metaline')  ##select(CSS selecter)=find_all
        author = ''
        title = ''
        date = ''
        if metas:
        ...
        except Exception as e:  ##Exception as e : 當上述try錯誤時強制執行下列程式碼
            ip = ''
